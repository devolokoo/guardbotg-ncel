...
if(!args[0]) return message.channel.send('Bir link ve ad yazmalısın. `e!emojiekle  emojiismi`');
if(!args[0].endsWith('.png')) return message.channel.send('Doğru bir link yazmalısın.');
if(!args[1]) return message.channel.send('Bir emoji adı yazmalısın. `e!emojiekle  emojiismi`');
