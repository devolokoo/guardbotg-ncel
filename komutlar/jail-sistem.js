...
message.channel.send(new Discord.MessageEmbed().setColor('#000001').setTitle('DeVoLoKo Jail Karantina Sistem').setDescription(`
...
.addField('Örnek Jail komut', `\`\`\`${client.ayarlar.prefix}jail @etiket\`\`\``)
.addField('ᅠ', 'ᅠ')// xd
